...
const TEMPLATE: &'static str = "complete -c eg !SHORT! -l !LONG! -d '!DOC!'";
const TEMPLATE_NEGATED: &'static str =
    "complete -c eg -l !NEGATED! -n '__eg_contains_opt !LONG! !SHORT!' -d '!DOC!'\n";
    ...
    for flag in FLAGS.iter() {
        ...
        match flag.completion_type() {
            ...
            CompletionType::Filetype => {
                completion.push_str(" -r -f -a '(eg --type-list | string replace : \\t)'");
            },
