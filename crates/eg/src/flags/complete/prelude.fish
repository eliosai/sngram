# Usage: __eg_contains_opt LONG [SHORT]
function __eg_contains_opt --description 'Specialized __fish_contains_opt'
    ...
    set -l commandline (commandline -cpo) (commandline -ct) $__eg_config
