...
impl Flag for Index {
    ...
    fn doc_short(&self) -> &'static str {
        r"Use sparse n-gram indexed search."
    }
    fn doc_long(&self) -> &'static str {
        r"
...
/// --index-backend
#[derive(Debug)]
struct IndexBackendFlag;

impl Flag for IndexBackendFlag {
    fn is_switch(&self) -> bool {
        false
    }
    fn name_long(&self) -> &'static str {
    ...
    fn doc_short(&self) -> &'static str {
        r"Select the sparse n-gram index backend."
    }
    fn doc_long(&self) -> &'static str {
        r"
...
impl Flag for NoIndex {
    ...
    fn doc_short(&self) -> &'static str {
        r"Disable eg's sparse n-gram index."
    }
    fn doc_long(&self) -> &'static str {
        r"
...
impl Flag for PCRE2Version {
    ...
    fn doc_short(&self) -> &'static str {
        r"Print the version of PCRE2 that elgrep uses."
    }
    fn doc_long(&self) -> &'static str {
        r"
When this flag is present, elgrep will print the version of PCRE2 in use,
along with other information, and then exit. If PCRE2 is not available, then
elgrep will print an error message and exit with an error code.
"
    }
